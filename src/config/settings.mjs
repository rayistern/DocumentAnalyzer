            ...
            content: `${overview ? overview + '\n\n' : ''}Provide metadata (in English) in the following JSON format (with no preface):
{
    ...
    "category": ["MARRIAGE"] -- One single category from this list: 'ACADEMIC' (scholarly letters), 'EDUCATION', 'SHLICHUT', 'FESTIVALS' (including all holidays or commemorations), 'BELIEF', 'MARRIAGE' (including dating, divorce, engagement, etc.), 'HEALTH', 'MONEY', 'CHARITY', 'JOY', 'PURPOSE', 'POLITICS', 'SCIENCE', 'ISRAEL', 'CHILDREN', 'FERTILITY' (birth, pregnancy, etc.), 'LIFECYCLE' (grief, mourning, tragedy), 'MOSHIACH' (the time to come, resurrection, third temple, etc.), 'CHASSIDUT' (mysticism, spirituality, etc.), 'HALACHA' (practices, traditions, etc.), 'SOCIETY' (non-jews, etc.)
}`
        }),
